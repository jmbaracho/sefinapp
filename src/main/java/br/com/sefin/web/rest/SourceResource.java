...
import br.com.sefin.service.SourceService;
...
/**
 * REST controller for managing {@link br.com.sefin.domain.Source}.
 */
@RestController
@RequestMapping("/api")
public class SourceResource {
     ...
     */
    @GetMapping("/sources")
    public ResponseEntity<List<SourceDTO>> getAllSources(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
