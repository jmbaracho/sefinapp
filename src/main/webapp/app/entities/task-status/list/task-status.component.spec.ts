...
describe('TaskStatus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'task-status', component: TaskStatusComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TaskStatusComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to taskStatusService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTaskStatusIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTaskStatusIdentifier).toHaveBeenCalledWith(entity);
