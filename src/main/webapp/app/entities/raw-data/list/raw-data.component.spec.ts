...
describe('RawData Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'raw-data', component: RawDataComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rawData?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to rawDataService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRawDataIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRawDataIdentifier).toHaveBeenCalledWith(entity);
